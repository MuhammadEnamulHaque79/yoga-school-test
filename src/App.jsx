function App() {
  ...
  return (
    <>
      <h1 className="text-3xl font-bold text-center">Do not dis-hearted </h1>
      <br />
      <footer className=" flex footer items-center justify-between p-4 bg-neutral text-neutral-content">
